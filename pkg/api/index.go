...
func (hs *HTTPServer) getProfileNode(c *models.ReqContext) *dtos.NavLink {
	...
	children := []*dtos.NavLink{
		{
			Text: "プロフィール", Id: "profile/settings", Url: hs.Cfg.AppSubURL + "/profile", Icon: "sliders-v-alt",
		},
	}
	...
	if setting.AddChangePasswordLink() {
		children = append(children, &dtos.NavLink{
			Text: "パスワード 変更", Id: "profile/password", Url: hs.Cfg.AppSubURL + "/profile/password",
			Icon: "lock",
		})
	}
